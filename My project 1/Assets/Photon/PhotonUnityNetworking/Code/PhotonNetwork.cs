...
namespace Photon.Pun
{
    ...
    public static partial class PhotonNetwork
    {
        ...
        private static GameObject NetworkInstantiate(Pun.InstantiateParameters parameters, bool roomObject = false, bool instantiateEvent = false)
        {
            ...
            Debug.Log("Network");
            go.tag = "Clone";
            go.transform.Find("MiniMapPlayer").gameObject.SetActive(false);
            go.transform.Find("MapMark").gameObject.SetActive(false);
            go.transform.Find("MiniMapMark").gameObject.SetActive(false);
            go.transform.Find("CameraMiniMap").gameObject.SetActive(false);
